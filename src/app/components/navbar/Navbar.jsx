...
const Navbar = () => {
  return (
    <nav className="flex justify-center w-full flex-col items-center min-[768px]:flex-row min-[1150px]:w-[1000px] min-[1300px]:w-[1200px] mx-auto h-[150px] min-[615px]:h-[70px]">
      <section className="bg-transparent text-white w-full flex flex-row justify-around	items-center flex-wrap p-6">
