...
const Navbar = () => {
  return (
    <nav className="flex justify-center w-full flex-col items-center absolute top-0 left-0 ">
      <section className="bg-white gap-3 text-black w-full flex flex-col justify-between items-center p-3 min-[768px]:flex-row " >
      <article>
          <ul className="flex flex-row justify-center flex-wrap gap-5 ml-2">
